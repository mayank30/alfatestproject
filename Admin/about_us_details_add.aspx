<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="about_us_details_add.aspx.cs" Inherits="ALAFAQKWT.Admin.about_us_details_add" %>
     ...
     <uc1:headermenu ID="headermenu" runat="server" />
            ...
            <div class="inner">
                 ...
                 <div class="onecolumn" >
                        ...
                        <div class="header"><span><span class="ico gray window"></span>  Add About Us </span>
                        ...
                        <div class="content" >
                              ...
                              <div class="section" >
                                  ...
                                  <div>   <asp:TextBox ID="txtTitle" runat="server" CssClass="BlackTextSmall" Width="200px"></asp:TextBox>
                          </div>
                          </div>
                            <div class="section" >
                                  <label> Left Title</label>   
                                  <div>   <asp:TextBox ID="txtLeft" runat="server" CssClass="BlackTextSmall" Width="200px"></asp:TextBox>
                          </div>
                          </div>
                           ...
                           <div class="section">
                            <label> Image</label>
                            <div>
                                  <asp:Image ID="Image2" runat="server" Width="160" Height="90" />
                                                                                <br />
                                <asp:FileUpload ID="uFile" runat="server" class="fileupload" onchange="return FunCheckFile(this);" /><label> Size 1920 x 730 px</label> 
                                 <asp:Label ID="FilenameLabel" Visible="false" runat="server" Text="Label"></asp:Label><br /><asp:HiddenField ID="hdfID" runat="server" />
                            </div>
                            ...
                            <div class="section" >
                              ...
                              <div class="section last">
                                  <div>
                                   <asp:LinkButton ID="btnadd"  runat="server" class="uibutton loading" Text="Add About Us" OnClick="btnadd_Click" ></asp:LinkButton>
                                        <asp:LinkButton ID="btnCancel"  runat="server" class="uibutton loading" Text="Back" OnClick="btnCancel_Click"></asp:LinkButton>
                                    </div>
                             </div>
                   ...
                   <div class="clear"></div>
                    <div id="footer"> &copy; Copyright 2018<span class="tip"><a  href="" title="" > Powered by The Avenues </a> </span> </div>
                </div> <!--// End inner --> 
            </div> <!--// End content --> 
    </form>
</body>
