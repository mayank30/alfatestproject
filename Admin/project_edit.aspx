<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="project_edit.aspx.cs" Inherits="Alfa.Admin.project_edit" %>
     ...
     <div id="content">
            <div class="inner">
                 ...
                 <div class="onecolumn" >
                        ...
                        <div class="header"><span><span class="ico gray window"></span>  Edit Project </span>
                        ...
                        <div class="content" >
                            ...
                            <div>
                                  <asp:Image ID="Image1" runat="server" Width="160" Height="90" />
                                                                                <br />
                                <asp:FileUpload ID="uFileImage" runat="server" class="fileupload" onchange="return FunCheckFile(this);" />
                              ...
                              <div class="section last">
                                  <div>
                                   <asp:LinkButton ID="btnadd"  runat="server" class="uibutton loading" Text="Edit Projects"    OnClientClick="return validate();" OnClick="btnadd_Click"></asp:LinkButton>
