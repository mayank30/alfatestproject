<%@ Page Language="C#" AutoEventWireup="true" CodeFile="servic.aspx.cs" Inherits="Admin_banners" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="content">
            <div class="inner">
                ...
                <div class="onecolumn">
                    <div class="header">
                        <span><span class="ico  gray spreadsheet"></span>Services </span>
                    </div>
                    <!-- End header -->
                    <div class=" clear" style="text-align: center;">

                        <a href="service_add.aspx" class="button">Add Services </a>
                                            ...
                                            <table class="display data_table2">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>
                                                            <div class="th_wrapp" style="text-align: left;">Service Name</div>
                                                        </th>
