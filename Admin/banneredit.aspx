<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="banneredit.aspx.cs" Inherits="ALAFAQKWT.Admin.banneredit" %>
...
<body>
        ...
        <div id="content">
            <div class="inner">
                ...
                <div class="onecolumn">
                    ...
                    <div class="header">
                        <span><span class="ico gray window"></span>Edit Banner </span>
                    ...
                    <div class="content">
                        ...
                        <div class="section">
                            ...
                            <div>
                                <asp:TextBox ID="Txtname" runat="server" CssClass="BlackTextSmall" Width="200px"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="section">
                            ...
                            <div>
                                  <asp:Image ID="Image1" runat="server" Width="160" Height="90" />
                                                                                <br />
                                <asp:FileUpload ID="uFileImage" runat="server" class="fileupload" onchange="return FunCheckFile(this);" /><label> Size 1920 x 730 px</label> 
                                 <asp:Label ID="FilenameLabel" Visible="false" runat="server" Text="Label"></asp:Label><br />
                            </div>
                        </div>
                        ...
                        <div class="section">
                            <label>Link</label>
                            <div>
                                <asp:RadioButton ID="rbn_link_yes" runat="server" Font-Bold="True" GroupName="grp_link" OnClick="function_enable();" />Yes
                &nbsp;<asp:RadioButton ID="rbn_link_no" runat="server" Font-Bold="True" Checked="True" GroupName="grp_link" OnClick="function_enable();" />No
                            </div>
                        </div>
                        ...
                        <div class="section">
                            ...
                            <div>
                                <asp:TextBox ID="Txtpostion" runat="server" CssClass="BlackTextSmall" Text="1" Width="50px"></asp:TextBox></div>
                        </div>
                        ...
                        <div class="section last">
                            <div>
                                <asp:LinkButton ID="btnadd" runat="server" class="uibutton loading" Text="Edit Banner" OnClientClick="return validate();" OnClick="btnadd_Click"></asp:LinkButton>
                ...
                <div class="clear"></div>
                <div id="footer">&copy; Copyright 2013<span class="tip"><a href="" title=""> </a></span></div>
            </div>
            <!--// End inner -->
        </div>
        <!--// End content -->
    ...
    <script type="text/javascript">
        ...
        function validate() {
            ...
            if (document.getElementById("uFile").value.trim() == "") {
                err = true;
                alert("Upload Image");
