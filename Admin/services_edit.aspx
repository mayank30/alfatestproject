<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="services_edit.aspx.cs" Inherits="Admin.banneredit" %>
        ...
        <uc1:headermenu ID="headermenu" runat="server" />
            ...
            <div class="inner">
                 ...
                 <div class="onecolumn" >
                        ...
                        <div class="header"><span><span class="ico gray window"></span>  Edit Services </span>
                        ...
                        <div class="content" >
                              ...
                              <div class="section" >
                                  ...
                                  <div>   <asp:DropDownList ID="ddlService_Name" runat="server" AppendDataBoundItems="True" AutoPostBack="True"></asp:DropDownList>
                        ...
                        <div class="section">
                            ...
                            <div>
                              ...
                              <div class="section last">
                                  <div>
                                   <asp:LinkButton ID="btnadd"  runat="server" class="uibutton loading" Text="Add Service"    OnClientClick="return validate();" OnClick="btnadd_Click"></asp:LinkButton>
