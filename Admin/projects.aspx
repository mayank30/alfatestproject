<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="projects.aspx.cs" Inherits="Alfa.Admin.projects" %>
     ...
     <uc1:headermenu ID="headermenu" runat="server" />
        ...
        <div id="content">
            <div class="inner">
                ...
                <div class="onecolumn">
                    <div class="header">
                        <span><span class="ico  gray spreadsheet"></span>Projects </span>
                    </div>
                    <!-- End header -->
                    <div class=" clear" style="text-align: center;">

                        <a href="project_add.aspx" class="button">Add Projects </a>
                                            ...
                                            <table class="display data_table2">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>
                                                            <div class="th_wrapp" style="text-align: left;">Project Name</div>
                                                        </th>
