...
public partial class Admin_banners : System.Web.UI.Page
{
    ...
    public void pub_bind_grid()
    {
        ...
        try
        {
            ...
            cmd.CommandText = "sp_get_serviceslist";
            ...
            if (rdr.HasRows)
            {
                while (rdr.Read())
                {
                    ...
                    sb.Append(String.Format(@"<td style=""text-align:left"">{0}</td>", rdr["service_name"].ToString()));
                    //sb.Append(String.Format(@"<td style=""text-align:left"">{0}</td>", rdr["show"].ToString()));
                    sb.Append(String.Format(@"<td class=""left""><img src=""../images/services/{0}"" width=""200px"" height=""50px"" /></td>", rdr["img_url"].ToString()));
                    ...
                    sb.Append(String.Format(@"<td class=""center""><span class=""tip"" ><a  title=""Edit"" href=""services_edit.aspx?key={0}"" ><img src=""images/icon/icon_edit.png"" ></a></span></td>", rdr["id"]));
                    sb.Append(String.Format(@"<td class=""center""><span class=""tip"" ><a id=""1"" href=""deletedata.aspx?methodname=deleteservices&key={0}""   onclick=""javascript:return confirm('Are you sure you want to delete?')""  name=""{1}"" title=""Delete""  ><img src=""images/icon/icon_delete.png"" ></a></span></td>", rdr["id"], rdr["service_name"]));
